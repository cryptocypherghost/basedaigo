...
// TODO(marun) Indicate that the methods defined in this file are part of the Network type defined principally in network.go

// Defines crud functionality methods supporting network configuration being read
// from and written to disk.

var (
	errMissingNetworkDir = errors.New("failed to write network: missing network directory")
)
...
// Read set of nodes associated with the network from disk.
