...
func TestStandardTxExecutorAddValidatorTxEmptyID(t *testing.T) {
	...
	env := newEnvironment(t, false /*=postBanff*/, false /*=postCortina*/, false /*=postDFork*/)
	env.ctx.Lock.Lock()
	defer func() {
...
func TestStandardTxExecutorAddDelegator(t *testing.T) {
	...
	dummyH := newEnvironment(t, false /*=postBanff*/, false /*=postCortina*/, false /*=postDFork*/)
	...
	for _, tt := range tests {
		t.Run(tt.description, func(t *testing.T) {
			require := require.New(t)
			freshTH := newEnvironment(t, false /*=postBanff*/, false /*=postCortina*/, false /*=postDFork*/)
...
func TestStandardTxExecutorDForkAddValidator(t *testing.T) {
	require := require.New(t)
	env := newEnvironment(t, true /*=postBanff*/, true /*=postCortina*/, true /*=postDFork*/)
	env.ctx.Lock.Lock()
	defer func() {
		require.NoError(shutdownEnvironment(env))
	}()
